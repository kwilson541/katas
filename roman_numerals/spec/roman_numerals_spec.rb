...
describe 'roman numerals' do
	...
	it 'expects 2014 to translate to "MMXIV"' do
		expect(roman_numeral_converter(2014)).to eq "MMXIV"
	end

	it 'expects 1999 to translate to "MCMXCIX"' do
		expect(roman_numeral_converter(1999)).to eq "MCMXCIX"
	end
